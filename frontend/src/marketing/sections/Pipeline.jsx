  ...
  return (
    <section className="py-24 md:py-40 border-t border-ovx-line">
      <div className="max-w-[1440px] mx-auto px-6 md:px-[120px]">
        ...
        {/* Desktop: dots on a hairline above labels */}
        ...
        {/* Mobile: vertical with staggered reveals per step */}
        <div className="flex md:hidden flex-col">
          {steps.map((step, i) => (
            <Reveal key={step.num} delay={i * 0.08} className="flex items-start gap-6">
